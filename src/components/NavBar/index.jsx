    ...
    return (
        <Nav className="drop-shadow-lg relative z-10 px-5">
            <ul className="flex gap-5">
                <ItemNavBar title={"Categorias"} list={genres} key_type={"name"} type_name={"name"} />
                <ItemNavBar title={"Plataformas"} list={providers} key_type={"provider_id"} type_name={"provider_name"} />
